...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        //设置ShareSDK
        ShareSDK.registerApp("119e104835e4d", activePlatforms: [SSDKPlatformType.SubTypeWechatSession.rawValue,SSDKPlatformType.SubTypeWechatTimeline.rawValue], onImport: { (platForm) -> Void in
            switch platForm {
...
//                break
        ...
        //设置LeanCloud
        AVOSCloud.setApplicationId("nJNnIx7pOrUzux3WpxPWSbRn-gzGzoHsz", clientKey: "o0VFtXN6vzThgMUEccOg8nFK")
        ...
        let tabbarItem2 = UITabBarItem(title: "发现", image: UIImage(named: "timer 2"), selectedImage: UIImage(named: "timre 2_red"))
