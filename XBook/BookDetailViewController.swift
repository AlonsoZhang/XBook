...
//  XBook
//
//  Created by Alonso Zhang on 16/4/8.
...
class BookDetailViewController: UIViewController,BookTabBarDelegate,InputViewDelegate,HZPhotoBrowserDelegate {
    ...
    override func viewDidLoad() {
        ...
        UIBarButtonItem.appearance().setBackButtonTitlePositionAdjustment(UIOffsetMake(0, -60), forBarMetrics: .Default)//设置 back 字的位置
    ...
    deinit{
        print("release")//每个界面都要加，确定都没有内存泄露
    }
